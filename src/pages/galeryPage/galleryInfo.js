    ...
    return (
      <div>
        <Modal open={openRegisterModal}>
          <div
            className="max-w-[1236px] bg-white rounded-[12px] px-8 text-justify xl:max-w-[1090px] 2lg:max-w-[900px]
            ...
            <div>
              {response && (
                <div>
                      ...
                      <SwiperSlide key={i.id}>
                        <div className="w-full max-h-[600px] overflow-hidden shadow-2xl">
                          <img
                            src={uri + i.image}
                            alt="img"
                            className="w-[100%] h-auto shadow-2xl"
                          />
                        </div>
                      </SwiperSlide>
                    ))}
                  ...
                  {i18n.language === 'ky' && (
                    <div>
                      <div className="block text-base text-blue font-medium mb-2 mt-4 ">
                        {response.title_ky}
                      </div>
