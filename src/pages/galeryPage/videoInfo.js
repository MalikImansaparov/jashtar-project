    ...
    return (
      <div>
        <Modal open={openRegisterModal}>
          <div
            className="max-w-[1236px] bg-white rounded-[12px] px-8 xl:max-w-[1090px] 2lg:max-w-[900px]
            ...
            <div>
              {response && (
                <div className="text-justify">
                  ...
                  {i18n.language === 'ky' && (
                    <>
                      <div className="block text-base text-blue font-medium mb-3 mt-[32px]">
                        {response.title_ky}
                      </div>
