...
const InfoTimeLine = () => {
    ...
    return (
        <div className=" wrapper pb-[104px] font-inter">
            <div className="wrapper pt-[42px] 1xs:mb-8 font-inter sm:ml-4 1xs:pt-0">
                <span className="crumbs text-grey" onClick={() => navigate('/timeline')}>{t("alltimeline")}<img src={arrow} alt="" className="arrow"/>{t("timeline")}</span>
            </div>
                                    ...
                                    <div className="">
                                        <div className="flex flex-wrap">
                                            {response.chrono.map((item) => (
                                                <div
                                                    className="flex max-w-[370px] mb-4 shadow-sm p-2 mr-4 rounded-[12px] 3xs:max-w-[350px] 3xs:p-1 3sm:max-w-[340px]"
                                                    key={item.id}
                                                >
