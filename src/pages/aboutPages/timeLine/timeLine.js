                ...
                <Tabs>
                    ...
                    {response?.map(item => (
                        <TabPanel key={item.id}>
                            ...
                            <div className="flex">
                                <div className="flex w-[291px] mr-[106px] shadow-sm p-3 rounded-[12px]">
                                <img
                                    src={path}
                                    alt="cart-img"
                                ...
                                <div className="">
                                    <p className="text-base text-blue font-extrabold mt-[62px]">
                                        Министерство культуры, информации, спорта и молодежной политики Кыргызской Республики выносит на общественное обсуждение проект НПА
                                    </p>
                                    <p className="text-base  font-normal my-[32px]">
                                        За годы независимости государственный орган управления отраслью физической культурой и
                                        спортом неоднократно реорганизовывался. Так, в 1994 году Государственный комитет Кыргызской ССР по физической культуре, спорту и туризму был реорганизован в Государственный комитет Кыргызской Республики по туризму и спорту.
                                    </p>
                                    <p className="text-base  font-normal my-[32px]">
