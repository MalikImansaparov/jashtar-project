  ...
  return (
    <div className="font-inter">
      <Popover open={openRegisterModal}>
        <div
          className="w-[1236px] h-auto bg-white rounded-[12px] p-[62px] shadow-org xl:w-[1090px] 2lg:w-[900px]
        ...
        >
                ...
                {i18n.language === 'ky' && (
                  <>
                    ...
                    <p className="text-justify text-base font-normal leading-[19.3px]">
                      <div
                        dangerouslySetInnerHTML={createMarkup(response.desc_ky)}
                      ></div>
                    </p>
                  </>
                )}
          ...
          <div className="mt-[62px]">
            {response && response.joint_project.length > 0 && (
              ...
              {response &&
                response.joint_project.map((item) => (
                  ...
                  >
                    ...
                    {i18n.language === 'ru' && (
                      <p className="font-normal text-base">{item.title_ru}</p>
                    )}
                    {i18n.language === 'en' && (
                      <p className="font-normal text-base">{item.title_en}</p>
                    )}
                  </div>
                ))}
            </div>
