        ...
        <div className="wrapper">
          ...
          {response && i18n.language === 'ky' && (
            <div>
              {isDesktop && (
                <>
                  <div className="flex mb-8 w-full justify-between 1xs:mb-0">
                ...
                <>
                  <div className="flex mb-8 w-full justify-between 1xs:mb-0">
                    ...
                    <div className=" ml-[70px] 1md:ml-[20px] ">
                      ...
                      <p className="text-justify 1xs:mt-0 sm:text-sm">
                        <Sanitized html={response.biography_ky} />
                      </p>
                    </div>
                  </div>
              ...
              {isMobile && (
                <>
                  <div className="flex mb-8 w-full justify-between 1xs:mb-0">
                    ...
                    <div className="ml-[70px] 1md:ml-[20px] mb-4 h-[180px] overflow-hidden">
                      <p className="font-base text-[18px] mb-[22px] text-blue 1md:mb-[10px] xs:mb-1 3xs:text-base leading-[2px] xs:text-[14px]">
                        {response.full_name_ky}
                      </p>
                      <p className="font-base text-grey text-base mb-8 1md:mb-4 xs:mb-0 sm:text-sm">
                        {response.annotation_ky}
                      </p>
                    </div>
                  </div>
                  <p className="text-justify w-full sm:text-sm">
                    <Sanitized html={response.biography_ky} />
                  </p>
                </>
              )}
