    ...
    return (
      <div>
        <div className="wrapper justify-center align-middle relative">
          {isDesktop && (
            <>
              <img
                src={line}
                alt=""
                className="absolute left-[-15px] top-[93px] h-0.5 w-[495px]"
              />
              <img
                src={line2}
                alt=""
                className="absolute left-[-14px] top-[95px] h-[630px] w-1 xl:h-[833px] md:h-[1020px]"
              />
            </>
          )}
          {isTablet && (
            <>
              <img
                src={line}
                alt=""
                className="absolute left-[-13px] top-[93px] w-[350px] h-1"
              />
              <img
                src={line2}
                alt=""
                className="absolute left-[-12px] top-[95px] h-[832px] w-1 md:h-[1060px]"
              />
            </>
          )}
          {isMobile && (
            <>
              <img
                src={line}
                alt=""
                className="absolute left-[-6px] top-[93px] w-[130px] h-1"
              />
              <img
                src={line2}
                alt=""
                className="absolute left-[-6px] top-[95px] h-[1473px] w-1"
              />
            </>
          )}

          {isDesktop && (
            <div className="mt-[70px] absolute top-[10%] left-[10.5%] xl:hidden">
            ...
            response
              ...
              .map((item) => (
                <Link to={`${item.id}`} key={item.id}>
                  <div className="relative block shadow-xl cursor-pointer w-[234px] h-[196px] pt-[1px] bg-white rounded-2xl text-center hover:shadow-2xl mb-4">
          ...
          {isDesktop && (
            <div className="mt-[70px] absolute top-[10%] right-[11.0%] xl:hidden">
              <RenderArrow
                angle={121.5}
                lenght={900}
                width={'350px'}
