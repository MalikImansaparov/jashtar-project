          ...
          {response &&
            response.results.map((item) => (
              <SwiperSlide key={item.id}>
                <Link to={`news/${item.id}`} className="block w-[384px] h-[419px] m-auto shadow-lg rounded bg-white pb-4 mb-4 leading-5 cursor-pointer hover:shadow-2xl 3lg:w-[384px] xl:w-[340px] 1sm:w-[384px] xs:w-[300px]">
